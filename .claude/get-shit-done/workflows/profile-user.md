...
```bash
cp "D:/sigorta-takip/.claude/get-shit-done/USER-PROFILE.md" "D:/sigorta-takip/.claude/USER-PROFILE.backup.md"
```
...
```bash
BACKUP_PATH="D:/sigorta-takip/.claude/USER-PROFILE.backup.md"
```
