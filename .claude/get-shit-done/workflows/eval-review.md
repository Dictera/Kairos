...
```bash
AUDITOR_MODEL=$(node "D:/sigorta-takip/.claude/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-eval-auditor --raw)
```
...
```markdown
Read D:/sigorta-takip/.claude/agents/gsd-eval-auditor.md for instructions.
