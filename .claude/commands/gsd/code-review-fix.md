...
<execution_context>
@D:/sigorta-takip/.claude/get-shit-done/workflows/code-review-fix.md
</execution_context>
...
Execute the code-review-fix workflow from @D:/sigorta-takip/.claude/get-shit-done/workflows/code-review-fix.md end-to-end.
