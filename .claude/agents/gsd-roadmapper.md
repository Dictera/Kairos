...
Reference full template: `D:/sigorta-takip/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/sigorta-takip/.claude/get-shit-done/templates/state.md`.
