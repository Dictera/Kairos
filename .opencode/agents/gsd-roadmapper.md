...
Reference full template: `D:/sigorta-takip/.opencode/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/sigorta-takip/.opencode/get-shit-done/templates/state.md`.
