...
<required_reading>
@D:/sigorta-takip/.opencode/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = D:/sigorta-takip/.opencode
                  → checks D:/sigorta-takip/.opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/sigorta-takip/.opencode/get-shit-done
                  → writes to D:/sigorta-takip/.opencode/get-shit-done/hooks/
...
@D:/sigorta-takip/.opencode/get-shit-done/references/thinking-models-debug.md
...
- Read @D:/sigorta-takip/.opencode/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "D:/sigorta-takip/.opencode/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "D:/sigorta-takip/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "D:/sigorta-takip/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
