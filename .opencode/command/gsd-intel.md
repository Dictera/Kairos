...
Intel system is disabled. To activate:
  ...
  node D:/sigorta-takip/.opencode/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node D:/sigorta-takip/.opencode/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node D:/sigorta-takip/.opencode/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node D:/sigorta-takip/.opencode/get-shit-done/bin/gsd-tools.cjs intel diff
```
