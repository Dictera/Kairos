...
```bash
AUDITOR_MODEL=$(node "D:/sigorta-takip/.opencode/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-eval-auditor --raw)
```
...
```markdown
Read D:/sigorta-takip/.opencode/agents/gsd-eval-auditor.md for instructions.
