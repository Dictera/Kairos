...
```bash
cp "D:/sigorta-takip/.opencode/get-shit-done/USER-PROFILE.md" "D:/sigorta-takip/.opencode/USER-PROFILE.backup.md"
```
...
```bash
BACKUP_PATH="D:/sigorta-takip/.opencode/USER-PROFILE.backup.md"
```
