...
Sigorta Uyuşmazlık Takip, solo avukat için yerel çalışan (offline-first) Next.js 16 web uygulamasıdır. İnternet bağlantısı gerektirmez; tüm veri yerel SQLite dosyasında tutulur.
